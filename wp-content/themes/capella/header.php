...
<body <?php body_class(); ?> <?php if(isset($pp_homepage_style) && !empty($pp_homepage_style)) { echo 'data-style="'.$pp_homepage_style.'"'; } ?> <?php if($shop_product_columns==3) { ?>data-shop="three_cols"<?php } ?>>
	...
	<?php
	    ...
	    {
	?>
	<form action="" method="get" id="form_option" name="form_option">
	    <div id="option_wrapper">
	    <div class="inner">
	    	<div style="text-align:center">
	    	<h6 class="space">SAMPLE DEMOS</h6>
	    	<ul class="demo_list">
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/demos/proxima_demo1.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Proxima Original</h6>
			    	    		<a href="http://themes.themegoods2.com/proxima" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/demos/proxima_demo2.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Proxima Creative<br/>& Photography</h6>
			    	    		<a href="http://themes.themegoods2.com/proxima_demos/2" target="_blank" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/demos/proxima_demo3.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Proxima Business & Corporate</h6>
			    	    		<a href="http://themes.themegoods2.com/proxima_demos/3" target="_blank" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/demos/proxima_demo4.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Proxima Food & Restaurant</h6>
			    	    		<a href="http://themes.themegoods2.com/proxima_demos/4" target="_blank" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/demos/soon.jpg" alt=""/>	   
	    		</li>
	    	</ul>
	    	</div>
	    
	    	<div style="text-align:center">
	    	<h6 class="space">DEMO OPTIONS</h6>
	    	This demo options are part of theme advanced admin options panel.
	    	</div><br/>
	    	<strong class="label">Sample Skins</strong>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == 'ff9900') { ?>selected<?php } ?>" href="javascript:;" title="Orange" data-color="ff9900" style="background:#ff9900;border-color:#ff9900"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == '3498db') { ?>selected<?php } ?>" href="javascript:;" title="Blue" data-color="3498db" style="background:#3498db;border-color:#3498db"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == 'f1c40f') { ?>selected<?php } ?>" href="javascript:;" title="Yellow" data-color="f1c40f" style="background:#f1c40f;border-color:#f1c40f"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == '76bb2c') { ?>selected<?php } ?>" href="javascript:;" title="Green" data-color="76bb2c" style="background:#76bb2c;border-color:#76bb2c"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == 'e74d3c') { ?>selected<?php } ?>" href="javascript:;" title="Red" data-color="e74d3c" style="background:#e74d3c;border-color:#e74d3c"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == 'ed6280') { ?>selected<?php } ?>" href="javascript:;" title="Pink" data-color="ed6280" style="background:#ed6280;border-color:#ed6280"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == '1abc9c') { ?>selected<?php } ?>" href="javascript:;" title="Ocean" data-color="1abc9c" style="background:#1abc9c;border-color:#1abc9c"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == '34495e') { ?>selected<?php } ?>" href="javascript:;" title="Asphalt" data-color="34495e" style="background:#34495e;border-color:#34495e"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == '9c59b6') { ?>selected<?php } ?>" href="javascript:;" title="Purple" data-color="9c59b6" style="background:#9c59b6;border-color:#9c59b6"></a>
	    	<a class="skin_box <?php if(isset($_GET['skin']) && $_GET['skin'] == '7dadff') { ?>selected<?php } ?>" href="javascript:;" title="Purple Blue" data-color="7dadff" style="background:#7dadff;border-color:#7dadff"></a>
	    	<input type="hidden" name="skin" id="skin" <?php if(isset($_GET['skin'])) { ?>value="<?php echo $_GET['skin']; ?>"<?php } ?>/>
	    	<br/><br/>
	    	<input type="checkbox" class="icheck" name="topbar" id="topbar" value="true" <?php if(isset($_GET['topbar']) && $_GET['topbar'] == 'true') { ?>checked=checked<?php } ?> /><div class="label">Display Top Bar</div>
	    	<br/>
	    	<strong class="label">Sample Typography</strong>
	    	<select name="font" id="font">
	    	    <option value="DosisOpensans" <?php if(isset($_GET['font']) && $_GET['font'] == 'DosisOpensans') { ?>selected=selected<?php } ?>>Dosis/Open Sans</option>
	    	    <option value="OxygenSourcesanspro" <?php if(isset($_GET['font']) && $_GET['font'] == 'OxygenSourcesanspro') { ?>selected=selected<?php } ?>>Oxygen/Source Sans Pro</option>
	    	    <option value="AbelUbuntu" <?php if(isset($_GET['font']) && $_GET['font'] == 'AbelUbuntu') { ?>selected=selected<?php } ?>>Abel/Ubuntu</option>
	    	    <option value="MontserratLato" <?php if(isset($_GET['font']) && $_GET['font'] == 'MontserratLato') { ?>selected=selected<?php } ?>>Montserrat/Lato</option>
	    	    <option value="RalewayRobotoCondensed" <?php if(isset($_GET['font']) && $_GET['font'] == 'RalewayRobotoCondensed') { ?>selected=selected<?php } ?>>Raleway/Roboto Condensed</option>
	    	</select>
	    	<br/><br/><br/>
	    	<a id="demo_apply" class="button" href="javascript:;">Apply</a><a class="button" href="http://themes.themegoods2.com/proxima">Reset</a>
	    	<br/><br/><hr/><br/>
	    	<div style="text-align:center">
	    		<i class="note_icon fa fa-star"></i>Theme included Revolution Slider plugin for FREE (You saved $16).
	    	</div>
	    </div>
	    </div>
	    <div id="option_btn">
			...
			<div id="menu_wrapper">
				...
				<?php
				    ...
				    {	
				    	...
				    	$pp_retina_logo_width = 151;
				    	$pp_retina_logo_height = 20;
				    }
				...
				<?php
					...
					if(empty($pp_logo_transparent) && empty($pp_retina_logo_transparent))
				    {
				    	...
				    	$pp_retina_logo_transparent_width = 151;
				    	$pp_retina_logo_transparent_height = 20;
				    }
				...
				if (class_exists('Woocommerce')) {
					...
					$pp_cart_header = get_option('pp_cart_header');
					global $woocommerce;
					$cart_url = $woocommerce->cart->get_cart_url();
					
					if(!empty($pp_cart_header))
					{
				?>
